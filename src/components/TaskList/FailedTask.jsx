...
const FailedTask = ({data, onStatusChange}) => {
  return (
    <div className=' flex-shrink-0 h-full  w-[300px] p-5 bg-gray-500 rounded-xl'>
            ...
            <button onClick={()=>onStatusChange('failed')} className='bg-red-500 text-white text-sm px-4 py-2 rounded-md'>Mark as failed</button>
